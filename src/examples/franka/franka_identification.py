...
# Set up Franka Model ----------------------------------
config_path = '/home/leo/Desktop/Base Inertial Parameter/src/examples/franka/franka_config.yaml'
...
std = 0.1 # normalized on real values
...
Identifier.save_plot(path = "/home/leo/Desktop/Base Inertial Parameter/src/examples/franka/results/before")     # 5_ save plot
...
Identifier.save_plot(path = "/home/leo/Desktop/Base Inertial Parameter/src/examples/franka/results")     # 5_ save plot
Identifier.export(path = "/home/leo/Desktop/Base Inertial Parameter/src/examples/franka/results")
