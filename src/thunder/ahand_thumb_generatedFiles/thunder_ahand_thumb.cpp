...
PYBIND11_MODULE(thunder_ahand_thumb_py, m) {
	py::class_<thunder_ahand_thumb>(m, "thunder_ahand_thumb")
		...
		.def_readonly("Dl_order", &thunder_ahand_thumb::Dl_order, "Order of the link friction model")
		.def_readonly("STD_PAR_LINK", &thunder_ahand_thumb::STD_PAR_LINK, "Standard number of dynamic parameters per link")
		.def_readonly("jointsType", &thunder_ahand_thumb::jointsType, "Type of joints")
		.def_readonly("numJoints", &thunder_ahand_thumb::numJoints, "Number of joints")
		.def_readonly("r1", &thunder_ahand_thumb::r1, "Index of first revolute joint")
		.def_readonly("r2", &thunder_ahand_thumb::r2, "Index of sequent revolute joint not aligned with r1")

		.def("get_d3q", &thunder_ahand_thumb::get_d3q, "Get parameter: d3q")
		.def("get_d4q", &thunder_ahand_thumb::get_d4q, "Get parameter: d4q")
		.def("get_ddq", &thunder_ahand_thumb::get_ddq, "Get parameter: ddq")
		.def("get_ddqr", &thunder_ahand_thumb::get_ddqr, "Get parameter: ddqr")
		.def("get_dq", &thunder_ahand_thumb::get_dq, "Get parameter: dq")
		.def("get_dqr", &thunder_ahand_thumb::get_dqr, "Get parameter: dqr")
		.def("get_par_DYN", &thunder_ahand_thumb::get_par_DYN, "Get parameter: par_DYN")
		.def("get_par_Dl", &thunder_ahand_thumb::get_par_Dl, "Get parameter: par_Dl")
		.def("get_par_Ia", &thunder_ahand_thumb::get_par_Ia, "Get parameter: par_Ia")
		.def("get_par_Ln2EE", &thunder_ahand_thumb::get_par_Ln2EE, "Get parameter: par_Ln2EE")
		.def("get_par_REG", &thunder_ahand_thumb::get_par_REG, "Get parameter: par_REG")
		.def("get_par_REG_red", &thunder_ahand_thumb::get_par_REG_red, "Get parameter: par_REG_red")
		.def("get_par_gravity", &thunder_ahand_thumb::get_par_gravity, "Get parameter: par_gravity")
		.def("get_par_world2L0", &thunder_ahand_thumb::get_par_world2L0, "Get parameter: par_world2L0")
		.def("get_q", &thunder_ahand_thumb::get_q, "Get parameter: q")
		.def("get_w", &thunder_ahand_thumb::get_w, "Get parameter: w")
		.def("set_d3q", &thunder_ahand_thumb::set_d3q, "Set parameter: d3q", py::arg("value"))
		.def("set_d4q", &thunder_ahand_thumb::set_d4q, "Set parameter: d4q", py::arg("value"))
		.def("set_ddq", &thunder_ahand_thumb::set_ddq, "Set parameter: ddq", py::arg("value"))
		.def("set_ddqr", &thunder_ahand_thumb::set_ddqr, "Set parameter: ddqr", py::arg("value"))
		.def("set_dq", &thunder_ahand_thumb::set_dq, "Set parameter: dq", py::arg("value"))
		.def("set_dqr", &thunder_ahand_thumb::set_dqr, "Set parameter: dqr", py::arg("value"))
		.def("set_par_DYN", &thunder_ahand_thumb::set_par_DYN, "Set parameter: par_DYN", py::arg("value"))
		.def("set_par_Dl", &thunder_ahand_thumb::set_par_Dl, "Set parameter: par_Dl", py::arg("value"))
		.def("set_par_Ia", &thunder_ahand_thumb::set_par_Ia, "Set parameter: par_Ia", py::arg("value"))
		.def("set_par_Ln2EE", &thunder_ahand_thumb::set_par_Ln2EE, "Set parameter: par_Ln2EE", py::arg("value"))
		.def("set_par_REG", &thunder_ahand_thumb::set_par_REG, "Set parameter: par_REG", py::arg("value"))
		.def("set_par_REG_red", &thunder_ahand_thumb::set_par_REG_red, "Set parameter: par_REG_red", py::arg("value"))
		.def("set_par_gravity", &thunder_ahand_thumb::set_par_gravity, "Set parameter: par_gravity", py::arg("value"))
		.def("set_par_world2L0", &thunder_ahand_thumb::set_par_world2L0, "Set parameter: par_world2L0", py::arg("value"))
		.def("set_q", &thunder_ahand_thumb::set_q, "Set parameter: q", py::arg("value"))
		.def("set_w", &thunder_ahand_thumb::set_w, "Set parameter: w", py::arg("value"))
		...
		.def("get_Dl1", &thunder_ahand_thumb::get_Dl1, "SEA manipulator link damping, order 1")
		.def("get_Dl2", &thunder_ahand_thumb::get_Dl2, "SEA manipulator link damping, order 2")
		...
		.def("get_Ia", &thunder_ahand_thumb::get_Ia, "Manipulator motor inertia torque")
		...
		.def("get_T_0", &thunder_ahand_thumb::get_T_0, "relative transformation from frame world to base")
		...
		.def("get_T_JOINT_P", &thunder_ahand_thumb::get_T_JOINT_P, "Template transformation of general prismatic joint R")
		.def("get_T_JOINT_R", &thunder_ahand_thumb::get_T_JOINT_R, "Template transformation of general rotoidal joint R")
		.def("get_T_w_0", &thunder_ahand_thumb::get_T_w_0, "absolute transformation from frame world to base")
		.def("get_T_w_1", &thunder_ahand_thumb::get_T_w_1, "absolute transformation from frame base to frame 1")
		.def("get_T_w_2", &thunder_ahand_thumb::get_T_w_2, "absolute transformation from frame base to frame 2")
		.def("get_T_w_3", &thunder_ahand_thumb::get_T_w_3, "absolute transformation from frame base to frame 3")
		.def("get_T_w_4", &thunder_ahand_thumb::get_T_w_4, "absolute transformation from frame base to frame 4")
		.def("get_T_w_5", &thunder_ahand_thumb::get_T_w_5, "absolute transformation from frame base to end_effector")
		.def("get_T_w_ee", &thunder_ahand_thumb::get_T_w_ee, "absolute transformation from frame 0 to end_effector")
		.def("get_Yr", &thunder_ahand_thumb::get_Yr, "Manipulator regressor matrix")
		.def("get_Yr_red", &thunder_ahand_thumb::get_Yr_red, "Regressor defined w.r.t the set of base iniertial parameters.")
		.def("get_beta", &thunder_ahand_thumb::get_beta, "linear relationship between full dyn parameters and the reduced set. beta s.t. par_red = beta*par.")
		.def("get_dl", &thunder_ahand_thumb::get_dl, "Manipulator link friction")
		.def("get_dyn2reg", &thunder_ahand_thumb::get_dyn2reg, "Conversion from dynamic to regressor parameters")
		.def("get_par_KIN", &thunder_ahand_thumb::get_par_KIN, "Internal kinematic parameters.")
		.def("get_reg2dyn", &thunder_ahand_thumb::get_reg2dyn, "Conversion from regressor to dynamic parameters")
		.def("get_reg2red", &thunder_ahand_thumb::get_reg2red, "Conversion from regressor to base inertial parameters.")
		.def("get_reg_C", &thunder_ahand_thumb::get_reg_C, "Regressor matrix of term C*dqr")
		.def("get_reg_C_red", &thunder_ahand_thumb::get_reg_C_red, "Regressor of centripetal defined w.r.t the set of base iniertial parameters.")
		.def("get_reg_G", &thunder_ahand_thumb::get_reg_G, "Regressor matrix of term G")
		.def("get_reg_G_red", &thunder_ahand_thumb::get_reg_G_red, "Regressor of gravity defined w.r.t the set of base iniertial parameters.")
		.def("get_reg_Ia", &thunder_ahand_thumb::get_reg_Ia, "Regressor matrix of the motor inertia")
		...
		.def("get_reg_M_red", &thunder_ahand_thumb::get_reg_M_red, "Regressor of masses defined w.r.t the set of base iniertial parameters.")
		.def("get_reg_dl", &thunder_ahand_thumb::get_reg_dl, "Regressor matrix of the link friction");
}

thunder_ahand_thumb::thunder_ahand_thumb(){}

// get the parameter: d3q
Vector<double,4> thunder_ahand_thumb::get_d3q() {return d3q;}
// get the parameter: d4q
Vector<double,4> thunder_ahand_thumb::get_d4q() {return d4q;}
// get the parameter: ddq
Vector<double,4> thunder_ahand_thumb::get_ddq() {return ddq;}
// get the parameter: ddqr
Vector<double,4> thunder_ahand_thumb::get_ddqr() {return ddqr;}
// get the parameter: dq
Vector<double,4> thunder_ahand_thumb::get_dq() {return dq;}
// get the parameter: dqr
Vector<double,4> thunder_ahand_thumb::get_dqr() {return dqr;}
...
Vector<double,6> thunder_ahand_thumb::get_par_world2L0() {return par_world2L0;}
// get the parameter: q
Vector<double,4> thunder_ahand_thumb::get_q() {return q;}
// get the parameter: w
Vector<double,6> thunder_ahand_thumb::get_w() {return w;}
// set the parameter: d3q
void thunder_ahand_thumb::set_d3q(Vector<double,4> value) {d3q = value;}
// set the parameter: d4q
void thunder_ahand_thumb::set_d4q(Vector<double,4> value) {d4q = value;}
// set the parameter: ddq
void thunder_ahand_thumb::set_ddq(Vector<double,4> value) {ddq = value;}
// set the parameter: ddqr
void thunder_ahand_thumb::set_ddqr(Vector<double,4> value) {ddqr = value;}
// set the parameter: dq
void thunder_ahand_thumb::set_dq(Vector<double,4> value) {dq = value;}
// set the parameter: dqr
void thunder_ahand_thumb::set_dqr(Vector<double,4> value) {dqr = value;}
...
void thunder_ahand_thumb::set_par_world2L0(Vector<double,6> value) {par_world2L0 = value;}
// set the parameter: q
void thunder_ahand_thumb::set_q(Vector<double,4> value) {q = value;}
// set the parameter: w
void thunder_ahand_thumb::set_w(Vector<double,6> value) {w = value;}

// Save parameters to file
int thunder_ahand_thumb::save_par(string par_file, vector<string> par_list){
	YAML::Node yamlFile;
...
int thunder_ahand_thumb::load_par(string par_file, vector<string> par_list){
	YAML::Node yamlFile;
	try {
...
Eigen::Matrix<double,4,4> thunder_ahand_thumb::get_Dl1() {
	thread_local double buffer[16];
	thread_local long long p3[ahand_thumb_Dl1_fun_SZ_IW];
	thread_local double p4[ahand_thumb_Dl1_fun_SZ_W];
	const double* input_[] = {par_Dl.data()};
	double* output_[] = {buffer};
	int check = ahand_thumb_Dl1_fun(input_, output_, p3, p4, 0);
	return Eigen::Map<Eigen::Matrix<double,4,4>>(buffer);
}

// SEA manipulator link damping, order 2
Eigen::Matrix<double,4,4> thunder_ahand_thumb::get_Dl2() {
	thread_local double buffer[16];
	thread_local long long p3[ahand_thumb_Dl2_fun_SZ_IW];
	thread_local double p4[ahand_thumb_Dl2_fun_SZ_W];
	const double* input_[] = {par_Dl.data()};
	double* output_[] = {buffer};
	int check = ahand_thumb_Dl2_fun(input_, output_, p3, p4, 0);
	return Eigen::Map<Eigen::Matrix<double,4,4>>(buffer);
}
...
Eigen::Matrix<double,4,4> thunder_ahand_thumb::get_T_JOINT_P(Vector<double,1> q_joint, Vector<double,3> axes) {
	...
	double* output_[] = {buffer};
	int check = ahand_thumb_T_JOINT_P_fun(input_, output_, p3, p4, 0);
	return Eigen::Map<Eigen::Matrix<double,4,4>>(buffer);
}
...
Eigen::Matrix<double,4,4> thunder_ahand_thumb::get_T_JOINT_R(Vector<double,1> q_joint, Vector<double,3> axes) {
	...
	const double* input_[] = {q_joint.data()};
	double* output_[] = {buffer};
	int check = ahand_thumb_T_JOINT_R_fun(input_, output_, p3, p4, 0);
	return Eigen::Map<Eigen::Matrix<double,4,4>>(buffer);
}

// absolute transformation from frame world to base
Eigen::Matrix<double,4,4> thunder_ahand_thumb::get_T_w_0() {
	thread_local double buffer[16];
	thread_local long long p3[ahand_thumb_T_w_0_fun_SZ_IW];
	thread_local double p4[ahand_thumb_T_w_0_fun_SZ_W];
	const double* input_[] = {par_world2L0.data()};
	double* output_[] = {buffer};
	int check = ahand_thumb_T_w_0_fun(input_, output_, p3, p4, 0);
	return Eigen::Map<Eigen::Matrix<double,4,4>>(buffer);
}

// absolute transformation from frame base to frame 1
Eigen::Matrix<double,4,4> thunder_ahand_thumb::get_T_w_1() {
	thread_local double buffer[16];
	thread_local long long p3[ahand_thumb_T_w_1_fun_SZ_IW];
	thread_local double p4[ahand_thumb_T_w_1_fun_SZ_W];
	const double* input_[] = {q.data(), par_world2L0.data()};
	double* output_[] = {buffer};
	int check = ahand_thumb_T_w_1_fun(input_, output_, p3, p4, 0);
	return Eigen::Map<Eigen::Matrix<double,4,4>>(buffer);
}

// absolute transformation from frame base to frame 2
Eigen::Matrix<double,4,4> thunder_ahand_thumb::get_T_w_2() {
	thread_local double buffer[16];
	thread_local long long p3[ahand_thumb_T_w_2_fun_SZ_IW];
	thread_local double p4[ahand_thumb_T_w_2_fun_SZ_W];
	const double* input_[] = {q.data(), par_world2L0.data()};
	double* output_[] = {buffer};
	int check = ahand_thumb_T_w_2_fun(input_, output_, p3, p4, 0);
	return Eigen::Map<Eigen::Matrix<double,4,4>>(buffer);
}

// absolute transformation from frame base to frame 3
Eigen::Matrix<double,4,4> thunder_ahand_thumb::get_T_w_3() {
	thread_local double buffer[16];
	thread_local long long p3[ahand_thumb_T_w_3_fun_SZ_IW];
	thread_local double p4[ahand_thumb_T_w_3_fun_SZ_W];
	const double* input_[] = {q.data(), par_world2L0.data()};
	double* output_[] = {buffer};
	int check = ahand_thumb_T_w_3_fun(input_, output_, p3, p4, 0);
	return Eigen::Map<Eigen::Matrix<double,4,4>>(buffer);
}

// absolute transformation from frame base to frame 4
Eigen::Matrix<double,4,4> thunder_ahand_thumb::get_T_w_4() {
	thread_local double buffer[16];
	thread_local long long p3[ahand_thumb_T_w_4_fun_SZ_IW];
	thread_local double p4[ahand_thumb_T_w_4_fun_SZ_W];
	const double* input_[] = {q.data(), par_world2L0.data()};
	double* output_[] = {buffer};
	int check = ahand_thumb_T_w_4_fun(input_, output_, p3, p4, 0);
	return Eigen::Map<Eigen::Matrix<double,4,4>>(buffer);
}

// absolute transformation from frame base to end_effector
Eigen::Matrix<double,4,4> thunder_ahand_thumb::get_T_w_5() {
	thread_local double buffer[16];
	thread_local long long p3[ahand_thumb_T_w_5_fun_SZ_IW];
	thread_local double p4[ahand_thumb_T_w_5_fun_SZ_W];
	const double* input_[] = {q.data(), par_world2L0.data(), par_Ln2EE.data()};
	double* output_[] = {buffer};
	int check = ahand_thumb_T_w_5_fun(input_, output_, p3, p4, 0);
	return Eigen::Map<Eigen::Matrix<double,4,4>>(buffer);
}

// absolute transformation from frame 0 to end_effector
Eigen::Matrix<double,4,4> thunder_ahand_thumb::get_T_w_ee() {
	thread_local double buffer[16];
	thread_local long long p3[ahand_thumb_T_w_ee_fun_SZ_IW];
	thread_local double p4[ahand_thumb_T_w_ee_fun_SZ_W];
	const double* input_[] = {q.data(), par_world2L0.data(), par_Ln2EE.data()};
	double* output_[] = {buffer};
	int check = ahand_thumb_T_w_ee_fun(input_, output_, p3, p4, 0);
	return Eigen::Map<Eigen::Matrix<double,4,4>>(buffer);
}
...
Eigen::Matrix<double,4,1> thunder_ahand_thumb::get_dl() {
	thread_local double buffer[4];
	thread_local long long p3[ahand_thumb_dl_fun_SZ_IW];
	thread_local double p4[ahand_thumb_dl_fun_SZ_W];
	const double* input_[] = {dq.data(), par_Dl.data()};
	double* output_[] = {buffer};
	int check = ahand_thumb_dl_fun(input_, output_, p3, p4, 0);
	return Eigen::Map<Eigen::Matrix<double,4,1>>(buffer);
}

// Conversion from dynamic to regressor parameters
Eigen::Matrix<double,40,1> thunder_ahand_thumb::get_dyn2reg() {
	thread_local double buffer[40];
	thread_local long long p3[ahand_thumb_dyn2reg_fun_SZ_IW];
	thread_local double p4[ahand_thumb_dyn2reg_fun_SZ_W];
	const double* input_[] = {par_DYN.data()};
	double* output_[] = {buffer};
	int check = ahand_thumb_dyn2reg_fun(input_, output_, p3, p4, 0);
	return Eigen::Map<Eigen::Matrix<double,40,1>>(buffer);
}

// Internal kinematic parameters.
Eigen::Matrix<double,24,1> thunder_ahand_thumb::get_par_KIN() {
	thread_local double buffer[24];
	thread_local long long p3[ahand_thumb_par_KIN_fun_SZ_IW];
	thread_local double p4[ahand_thumb_par_KIN_fun_SZ_W];
	const double** input_ = nullptr;
	double* output_[] = {buffer};
	int check = ahand_thumb_par_KIN_fun(input_, output_, p3, p4, 0);
...
Eigen::Matrix<double,40,1> thunder_ahand_thumb::get_reg2dyn() {
	thread_local double buffer[40];
	thread_local long long p3[ahand_thumb_reg2dyn_fun_SZ_IW];
	thread_local double p4[ahand_thumb_reg2dyn_fun_SZ_W];
...
Eigen::Matrix<double,4,24> thunder_ahand_thumb::get_reg_C_red() {
	thread_local double buffer[96];
	thread_local long long p3[ahand_thumb_reg_C_red_fun_SZ_IW];
	thread_local double p4[ahand_thumb_reg_C_red_fun_SZ_W];
	const double* input_[] = {q.data(), dq.data(), dqr.data(), par_world2L0.data()};
	double* output_[] = {buffer};
	int check = ahand_thumb_reg_C_red_fun(input_, output_, p3, p4, 0);
...
Eigen::Matrix<double,4,24> thunder_ahand_thumb::get_reg_G_red() {
	thread_local double buffer[96];
	thread_local long long p3[ahand_thumb_reg_G_red_fun_SZ_IW];
	thread_local double p4[ahand_thumb_reg_G_red_fun_SZ_W];
	const double* input_[] = {q.data(), par_world2L0.data(), par_gravity.data()};
	double* output_[] = {buffer};
...
Eigen::Matrix<double,4,24> thunder_ahand_thumb::get_reg_M_red() {
	thread_local double buffer[96];
	thread_local long long p3[ahand_thumb_reg_M_red_fun_SZ_IW];
	thread_local double p4[ahand_thumb_reg_M_red_fun_SZ_W];
	const double* input_[] = {q.data(), ddqr.data(), par_world2L0.data()};
	double* output_[] = {buffer};
	int check = ahand_thumb_reg_M_red_fun(input_, output_, p3, p4, 0);
	return Eigen::Map<Eigen::Matrix<double,4,24>>(buffer);
}

// Regressor matrix of the link friction
Eigen::Matrix<double,4,8> thunder_ahand_thumb::get_reg_dl() {
	thread_local double buffer[32];
	thread_local long long p3[ahand_thumb_reg_dl_fun_SZ_IW];
	thread_local double p4[ahand_thumb_reg_dl_fun_SZ_W];
	const double* input_[] = {dq.data()};
	double* output_[] = {buffer};
	int check = ahand_thumb_reg_dl_fun(input_, output_, p3, p4, 0);
